...
export default function Logo() {
  return (
    <div className="flex items-center xl:gap-4 md:gap-3 gap-2">
      <img
        className="xl:w-12 xl:h-11 lg:w-11 lg:h-10 md:w-10 md:h-9 w-9 h-8 "
        src={logo}
        alt="Digi Wallet Logo"
      />

      {/* <img className="xl:w-14 xl:h-12 lg:w-12 lg:h-10 md:w-[52px] md:h-[48px] w-10 h-9" src={logo} alt="Digi Wallet Logo" /> */}
      {/* <svg
          id="logo-16"
          width="80"
          height="43"
      ...
      <p className="font-bold italic xl:text-[17.5px]/loose lg:text-[16.5px] md:text-[16.5px] text-[15.5px]">
        Digi Wallet
      </p>
    </div>
  );
