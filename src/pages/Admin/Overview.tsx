...
export default function Overview() {
  ...
  return (
    <div className="xl:p-12 lg:p-10 md:p-8 p-5 space-y-6">
      {/* banner */}
      <Card className="bg-gradient-to-r from-blue-500 to-purple-700 text-white shadow-xl rounded-2xl xl:h-64 lg:h-56 md:h-48 h-44 flex justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="hover:shadow-lg transition rounded-2xl bg-gradient-to-r from-cyan-300 to-purple-50 border-2 border-cyan-800">
        ...
        <Card className="hover:shadow-lg transition rounded-2xl bg-gradient-to-r from-green-300 to-purple-50 border-2 border-green-800">
          <CardContent className="flex flex-col items-center justify-center">
        ...
        <Card className="hover:shadow-lg transition rounded-2xl bg-gradient-to-r from-amber-300 to-purple-50 border-2 border-amber-800">
          <CardContent className="flex flex-col items-center justify-center">
        ...
        <Card className="hover:shadow-lg transition rounded-2xl bg-gradient-to-r from-pink-300 to-purple-50 border-2 border-pink-800">
          <CardContent className="flex flex-col items-center justify-center">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
        ...
        {adminStatsLoading ? (
          <></>
        ) : adminStats?.data?.roleBasedPieChartData.length === 0 ? (
          <></>
        ) : (
          <RoleBasedPieChart
        ...
        {adminStatsLoading ? (
          <></>
        ) : adminStats?.data?.transactionTypeBasedBarChartData.length === 0 ? (
          <></>
        ) : (
